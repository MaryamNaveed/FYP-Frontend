...
const [visibleExperience, setvisibleExperience] = React.useState(false);
  ...
  return (
    <Provider>
      ...
      <Portal>
        <Modal  visible={visibleSpecialization} onDismiss={hideModalSpecialization} contentContainerStyle={styles.modalAge}>
            <View>
                
            <TextInput mode='outlined'  label='Specialization' value={modalSpecialization} onChangeText={text => setModalSpecialization(text)}></TextInput>

        
        <Button mode='contained' buttonColor='#00ced1' style={styles.okbutton} onPress={okSpecialization}>Ok</Button>
        <Button mode='outlined' style={styles.cancelbutton} onPress={cancelSpecialization}>Cancel</Button>
            </View>
      ...
      <Portal>
        <Modal  visible={visibleExperience} onDismiss={hideModalExperience} contentContainerStyle={styles.modalAge}>
            <View>
                
            <TextInput mode='outlined' keyboardType='numeric' label='Experience(years)' value={modalExperience} onChangeText={text => setModalExperience(text)}></TextInput>

        
        <Button mode='contained' buttonColor='#00ced1' style={styles.okbutton} onPress={okExperience}>Ok</Button>
        <Button mode='outlined' style={styles.cancelbutton} onPress={cancelExperience}>Cancel</Button>
            </View>
      ...
      <Portal>
        <Modal visible={visibleEducation} onDismiss={hideModalEducation} contentContainerStyle={styles.modalAge}>
            <ScrollView>
                
            <TextInput mode='outlined' label='Education' value={modalEducation} onChangeText={text => setModalEducation(text)}></TextInput>

        
        <Button mode='contained' buttonColor='#00ced1' style={styles.okbutton} onPress={okEducation}>Ok</Button>
        <Button mode='outlined' style={styles.cancelbutton} onPress={cancelEducation}>Cancel</Button>
            </ScrollView>
     ...
     />
       ...
       <Text style={{  textAlign: 'center', color: 'cornflowerblue'}} variant="headlineMedium">Doctor</Text>
      <Text style={{  textAlign: 'center', marginTop: 5, marginBottom: 15, color: 'white'}} variant="titleMedium">doctor@gmail.com</Text>
            
             
      <TouchableOpacity style={styles.grid} activeOpacity={1} onPress={showModalEducation}>
           ...
           <TouchableOpacity style={styles.grid} activeOpacity={1} onPress={showModalSpecialization}>
           <Grid style={styles.mainGrid}>
             <Row>
               <Text style={{ fontWeight: 'bold', fontSize:14 }}>Specialization</Text>
             </Row>
             <Row>
               <Text style={{fontSize:14 }}>{specialization}</Text>
             </Row>
           </Grid>
           </TouchableOpacity>

    
           <TouchableOpacity style={styles.grid1} activeOpacity={1} onPress={showModalExperience}>
           <Grid style={styles.mainGrid1}>
             <Row>
               <Col ><Text style={styles.ColGridLeft}>Experience</Text></Col>
               <Col ><Text style={styles.ColGridRight} >{experience} yrs</Text></Col>
             </Row>
           </Grid>
           </TouchableOpacity>
